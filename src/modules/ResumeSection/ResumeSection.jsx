    ...
    <div className={styles.resume__container}>
      ...
      <div className={`${styles.resume__containerAboutme} ${styles.section}`}>
        ...
        <p className={styles.resume__aboutmeDescription}>
          <span>
            Soy un profesional creativo con una profunda pasión por el diseño. Mi formación como programador comenzó de
            manera autodidacta en 2023, en 2025 decidí formalizar mis conocimientos, comenzando mis estudios en
            programación web en la Universidad de San Juan.
          </span>
          <span>
            Mis estudios previos en música me permiten combinar mis habilidades técnicas en programación con una visión
            artística y funcional de los proyectos. Como profesor de música, he desarrollado una sólida formación
            pedagógica que me ha permitido adquirir habilidades transversales clave, como la comunicación efectiva, el
            aprendizaje autónomo, la resolución de problemas y el trabajo en equipo. Mi capacidad para abordar desafíos
            de manera innovadora y mi enfoque en los procesos creativos son la base de mi desarrollo profesional y
            personal.
          </span>
        </p>
      </div>
      ...
      <div className={`${styles.resume__containerExperience} ${styles.section}`}>
        ...
        <div className={styles.resume__sectionExperience}>
          ...
          <p>
            ...
            oportunidad profesional en el área. Sin embargo, he trabajado en diversos proyectos personales que puedes
            explorar en mi portafolio web (puedes encontrar el enlace en la sección de contacto). Estos proyectos
            reflejan mi capacidad para aplicar mis conocimientos de programación web en situaciones prácticas y mi
            dedicación por seguir aprendiendo y mejorando.
          </p>
        </div>
        <div className={styles.resume__sectionExperience}>
